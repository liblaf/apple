...
class Config(cherries.BaseConfig):
    ...
    output_summary: Path = cherries.output("10-surface-prestrain-forward-summary.json")
    output_csv: Path = cherries.output("10-surface-prestrain-forward-cases.csv")
    output_table: Path = cherries.output("10-surface-prestrain-forward-table.md")

    cases: tuple[str, ...] = ("515k-nosmas", "3152k-expression001")
