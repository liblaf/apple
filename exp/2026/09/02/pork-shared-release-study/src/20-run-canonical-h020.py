"""Canonical sequential h=.20 2-D band-muscle shared-to-independent study.
...
class Config(cherries.BaseConfig):
    ...
    output_dir: Path = cherries.output("20-canonical-h020", mkdir=True)
    cases: str = (
        "h020-direct,h020-shared,h020-shared-release,h020-shared-release_zero_u"
    )
