...
from liblaf.apple.struct.mapping import KeyLike, MappingTrait, as_key

from .node import GraphNode


@attrs.define
class Graph(MappingTrait[GraphNode]):
    _graph: nx.DiGraph = attrs.field(factory=nx.DiGraph)

    # region MappingTrait[GraphNode]
    ...
    # endregion MappingTrait[GraphNode]
