...
@wp.func
@no_type_check
def h1_quad(p: mat43, dhdX: mat43, g1: mat33) -> float_:
    """$p^T h_1 p$."""
...
@wp.func
@no_type_check
def h2_quad(p: mat43, dhdX: mat43, g2: mat33) -> float_:
    """$p^T h_2 p$."""
...
@wp.func
@no_type_check
def h3_quad(p: mat43, dhdX: mat43, g3: mat33) -> float_:
    """$p^T h_3 p$."""
...
@wp.func
@no_type_check
def h5_quad(p: mat43, dhdX: mat43) -> float_:
    """$p^T h_5 p$."""
    dFdx_p = deformation_gradient_jvp(dhdX, p)  # mat33
...
@wp.func
@no_type_check
def h6_quad(p: mat43, dhdX: mat43, F: mat33) -> float_:
    """$p^T h_6 p$."""
    dFdx_p = deformation_gradient_jvp(dhdX, p)  # mat33
    f0 = F[:, 0]
    f1 = F[:, 1]
