...
class ArapMuscleV2(Arap):
    ...
    def get_cell_params_func(params: Params, cid: int) -> ParamsElem:
        return ArapMuscleV2.ParamsElem(
    ...
    def energy_density_hess_diag_func(
        ...
        h4_diag = func.h4_diag(dhdX, U, s, A @ V, clamp=clamp)  # mat43
    ...
    def energy_density_hess_prod_func(
        ...
        G = F @ A  # mat33
        U, s, V = math.svd_rv(G)  # mat33, vec3, mat33
        h4_prod = func.h4_prod(p, dhdX, U, s, A @ V, clamp=clamp)  # mat43
    ...
    def energy_density_hess_quad_func(
        ...
        G = F @ A  # mat33
        U, s, V = math.svd_rv(G)  # mat33, vec3, mat33
        h4_quad = func.h4_quad(p, dhdX, U, s, A @ V, clamp=clamp)  # scalar
