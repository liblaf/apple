...
def test_h1_diag(
    ...
    check_diag(utils.h1_diag, utils.h1_quad, args, dhdX.dtype)
...
def test_h2_diag(
    ...
    check_diag(utils.h2_diag, utils.h2_quad, args, dhdX.dtype)
...
def test_h3_diag(
    ...
    check_diag(utils.h3_diag, utils.h3_quad, args, dhdX.dtype)
...
def test_h4_diag(
    ...
    check_diag(utils.h4_diag, utils.h4_quad, args, dhdX.dtype)
...
def test_h5_diag(dhdX: Float[Array, "batch 4 3"]) -> None:
    ...
    check_diag(utils.h5_diag, utils.h5_quad, args, dhdX.dtype)
...
def test_h6_diag(dhdX: Float[Array, "batch 4 3"], F: Float[Array, "batch 3 3"]) -> None:
    ...
    check_diag(utils.h6_diag, utils.h6_quad, args, dhdX.dtype)
